...
export default function SearchPage() {
  ...
  return (
    <MainLayout>
      <header className="mb-8 mt-4 sticky top-0 z-10 bg-gray-900/90 backdrop-blur-md pb-4 pt-4 rounded-lg px-2">
        <div className="relative w-full max-w-2xl mx-auto">
          ...
          <input
            type="text"
            className="block w-full pl-12 pr-4 py-4 bg-gray-800 border-none rounded-full text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 shadow-lg text-lg outline-none transition-all"
